...
export const PHOTO_CREDITS: Record<string, PhotoCredit> = {
  ...
  'hero-news': { author: 'Ninara', license: 'CC BY 2.0', licenseUrl: 'https://creativecommons.org/licenses/by/2.0', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Kilpisj%C3%A4rvi,_Finland_(51492924215).jpg', sourceId: 'Kilpisjärvi, Finland (51492924215).jpg (sha1 3cccdbc5d88a87b0f8fd12c645281fd3810b607a, 4990x3405)', taken: '2021-09-04', place: 'Kilpisjärvi', receipt: 'Wikimedia Commons, otettu käyttöön 26.9.2026, 0 €, vain pienennys (ei rajausta). Wellness käyttää saman päivän eri ruutua (hirsisauna, 51492688759), eri aihe' },
