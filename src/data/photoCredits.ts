...
export const PHOTO_CREDITS: Record<string, PhotoCredit> = {
  ...
  'hero-hiking': { author: 'Ninara', license: 'CC BY 2.0', licenseUrl: 'https://creativecommons.org/licenses/by/2.0', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Kiutak%C3%B6ng%C3%A4s_rapids6.jpg', sourceId: 'Kiutaköngäs rapids6.jpg (sha1 23c106f2a104b7ec4cd403635f54210c6eb7b5c1, 6241x4161)', taken: '2023-07-27', place: 'Kiutaköngäs, Oulanka, Kuusamo', receipt: 'Wikimedia Commons, otettu käyttöön 26.9.2026, 0 €, vain pienennys (ei rajausta). Korvasi Saanan pitkospuukuvan (Vesa 26.9.: ei houkuttele vaellukselle)' },
  'hero-news': { author: 'Ximonic (Simo Räsänen)', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0', sourceUrl: 'https://commons.wikimedia.org/wiki/File:River_Teno_near_Kuoppilasjoki,_Utsjoki,_Lapland,_Finland,_2021_September.jpg', sourceId: 'River Teno near Kuoppilasjoki, Utsjoki, Lapland, Finland, 2021 September.jpg (sha1 5c88edbb1d73bd02e96eb2443275ba4f11f98025, 5000x3333)', taken: '2021-09-19', place: 'Tenojoki, Kuoppilasjoki, Utsjoki', receipt: 'Wikimedia Commons, otettu käyttöön 26.9.2026, 0 €, vain pienennys (ei rajausta). Ninaran Kilpisjärvi-kuva siirtyi uutisjutun heroksi (Käsivarren porojen lähikuva zoomasi liikaa, Vesa)' },
  ...
  'card-northern-lights': { author: 'Martincco', license: 'CC BY-SA 4.0', licenseUrl: 'https://creativecommons.org/licenses/by-sa/4.0', sourceUrl: 'https://commons.wikimedia.org/wiki/File:Aurora_Borealis_-_polar_lights_3.jpg', sourceId: 'Aurora Borealis - polar lights 3.jpg (sha1 2e00c8917e6b3e6a8c7fbeac55a9e37e9914d7f9, 2400x1600)', taken: '2015-01-21', place: 'Inarijärvi', receipt: 'Wikimedia Commons, otettu käyttöön 26.9.2026, 0 €, vain pienennys 1280x853 (ei rajausta). Korvasi Daniele57C:n kuvan Aurora ad Inari - 1.jpg, jonka sisarruutu (sama ilta 14.3.2025, sama mökki) Aurora ad Inari - 2.jpg on laplandluxuryvillasin käytössä 23.9.2026 alkaen' },
