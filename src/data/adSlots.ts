...
const auroraHolidays: Partner = {
  ...
  url: 'https://go.laplandvibes.com/go/auroraholidays?sid=nature_card_b',
  urlFi: 'https://go.laplandvibes.com/go/auroraholidays?sid=nature_card_b&dest=https%3A%2F%2Fauroraholidays.net%2Ffi%2Fetusivu%2F',
