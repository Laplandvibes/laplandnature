...
export const IT_OVERRIDES: DeepPartial<SectionCopy> = {
  ...
  wildlife: {
    ...
    animals: [
      ...
      { name: 'Orso bruno', description: 'La Finlandia ha una delle popolazioni più dense di orso bruno in Europa. Nella Lapponia orientale e settentrionale, i capanni di osservazione offrono incontri ravvicinati nelle notti estive, quando gli orsi escono dal letargo.', status: 'Quasi minacciata' },
