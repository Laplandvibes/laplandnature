...
export const IT_OVERRIDES: DeepPartial<SectionCopy> = {
  ...
  newsletter: {
    ...
    benefits: [
      ...
      { title: 'Dove andremmo questo weekend', body: 'L\'angolo di cielo scuro che merita il viaggio. Il fiume prima dell\'arrivo dei cercatori d\'oro. Il fjäll che i nostri vicini sami hanno appena fotografato.' },
    ],
  ...
  map: {
    ...
    pins: [
      ...
      { name: 'Kilpisjärvi', note: 'Punto delle tre frontiere · fjäll d\'alta quota' },
  ...
  home: {
    ...
    hero: {
      ...
      subtitle: 'intatta',
      description: 'Lapponia finlandese, 100.367 km² di terre artiche, con sette parchi nazionali, fjäll, foreste antiche e la stagione di aurore più lunga d\'Europa.',
    ...
    featured: {
      ...
      items: [
        { tag: 'Aree protette', title: 'Parchi nazionali', blurb: 'La Lapponia ha sette parchi nazionali (circa 6.900 km² in tutto); ne presentiamo cinque, dai fjäll di Urho Kekkonen agli alberi coronati di neve di Riisitunturi.', cta: 'Esplora i parchi nazionali' },
        ...
        { tag: 'Sentieri', title: 'Trekking', blurb: 'Cammina sui sentieri più iconici della Finlandia, dai ponti sospesi del Karhunkierros (82 km) al punto più alto della Finlandia sull\'Halti (1.324 m).', cta: 'Esplora il trekking' },
        { tag: 'Tutela', title: 'Conservazione', blurb: 'Metsähallitus gestisce l\'85 % dei fjäll della Lapponia e tutti i sette parchi nazionali. In più il diritto di accesso alla natura, la legge finlandese di accesso libero.', cta: 'Esplora la conservazione' },
    ...
    map: {
      ...
      pins: [
        ...
        { name: 'Hetta', note: 'Estremità nord del sentiero Hetta–Pallas di 55 km' },
        { name: 'Ruka / Oulanka', note: 'Karhunkierros di 82 km · ponti sospesi e canyon · Kuusamo, appena a sud della Lapponia' },
        { name: 'Kilpisjärvi (Halti)', note: '55 km andata e ritorno all\'Halti, punto più alto della Finlandia (1.324 m)' },
        { name: 'Pyhä', note: 'Gola di Pyhäkuru · passerella accessibile · 5 km' },
  ...
  northernLights: {
    ...
    spots: [
      ...
      { name: 'Kilpisjärvi', description: 'Dove Finlandia, Svezia e Norvegia si incontrano. I fjäll d\'alta quota offrono panoramiche di aurora sopra la coltre nuvolosa del Mare Artico.' },
  ...
  nationalParks: {
    ...
    parks: [
      ...
      { name: 'Parco nazionale di Pallas-Yllästunturi', description: 'Ospita il più lungo sentiero di trekking popolare sui fjäll della Finlandia, i 55 km Hetta–Pallas. Cime aperte con orizzonti che arrivano fino al Käsivarsi.', highlight: 'Traversata di fjäll più lunga di Finlandia', visited: 'settembre 2023 · Hetta → Pallas in tre giorni · picco ruska settimana 2' },
    ...
    days: [
      { day: 'Giorno 1 · 18 km', title: 'Hetta → Sioskuru', body: 'Traghetto sull\'Ounasjärvi alle 9:00 (gratuito, dal 1° giugno al 30 settembre). In due ore si esce da Pyhäkero sul fjäll aperto. Il rifugio Sioskuru ha 16 posti; siamo arrivati alle 16:30 con tre cuccette ancora libere. Tramonto sui fjäll occidentali dalla porta.', note: '+520 m di dislivello · vento leggero' },
    ...
    faq: {
      ...
      items: [
        { q: 'Quanti parchi nazionali ci sono in Lapponia?', a: 'La regione della Lapponia ha sette parchi nazionali: Lemmenjoki, Urho Kekkonen, Pallas-Yllästunturi, Perämeri (Golfo di Botnia), Pyhä-Luosto, Salla e Riisitunturi, circa 6.900 km² in tutto. Inoltre Oulanka e Syöte si estendono in parte in Lapponia. Di questi ne presentiamo cinque nel dettaglio: Urho Kekkonen, Pallas-Yllästunturi, Lemmenjoki, Riisitunturi e Pyhä-Luosto. Ognuno ha il proprio villaggio-porta dove stabilire la base, da Saariselkä per l\'UKK fino a Hetta e Muonio per Pallas-Yllästunturi.' },
        { q: 'Qual è il parco nazionale più grande della Lapponia finlandese?', a: 'Il Parco nazionale di Urho Kekkonen è il più grande della Lapponia, con circa 2.550 km², e il secondo più grande di tutta la Finlandia. Si estende dai fjäll di Saariselkä verso est, fino a una profonda wilderness senza strade, con fjäll aperti, gole fluviali e antiche pinete.' },
  ...
  wildlife: {
    ...
    animals: [
      { name: 'Renna', description: 'Circa 200.000 renne semidomestiche percorrono la Lapponia finlandese, al centro della cultura pastorale sami da migliaia di anni. Pascolano libere su fjäll e foreste, le incontrerà a bordo strada.', status: 'Comune' },
      { name: 'Volpe artica', description: 'Uno dei mammiferi più rari della Finlandia. La volpe artica sopravvive negli ambienti più aspri dei fjäll, con la pelliccia che diventa bianca in inverno per mimetizzarsi nella neve. In pericolo critico nella popolazione scandinava.', status: 'In pericolo critico' },
      ...
      { name: 'Gufo delle nevi', description: 'Visitatore occasionale dei fjäll più settentrionali, il gufo delle nevi caccia i lemming nella tundra aperta. Gli avvistamenti dipendono dai cicli di popolazione dei lemming e raramente avvengono a sud di Utsjoki.', status: 'Visitatore raro' },
  ...
  seasons: {
    ...
    seasons: [
      { name: 'Ruska', period: 'Settembre – ottobre', description: 'La Lapponia esplode in vividi colori autunnali: betulle, pioppi e mirtilli virano all\'oro, al rosso e all\'arancio. Le cime dei fjäll attraversano lo spettro in giorni, non in settimane. Il ruska è uno degli eventi naturali simbolo dell\'anno finlandese, gli escursionisti arrivano da tutto il Paese per vederlo.' },
    ...
    ruskaWeeks: [
      { week: 'Settimana 1 · 2–8 set.', region: 'Utsjoki + Kilpisjärvi (69° N e oltre)', body: 'I fjäll più settentrionali partono per primi. Betulle già al 60 % di colorazione il 5 settembre; mirtilli rossi di un rosso profondo. Temperature notturne in bivacco di −2 °C. Finestra fotografica: 14:00–17:00, luce radente.' },
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Quando si verifica il sole di mezzanotte in Lapponia?', a: 'Il sole di mezzanotte va da circa inizio giugno a inizio luglio nella maggior parte della Lapponia, e più a lungo quanto più si sale a nord, nei fjäll più settentrionali il sole non tramonta del tutto per oltre 70 giorni di fila. Oltre il circolo polare può camminare, pescare o pagaiare a mezzanotte in pieno giorno.' },
        { q: 'Quando avviene il ruska (i colori d\'autunno) in Lapponia?', a: 'Il ruska scende da nord verso sud nell\'arco di circa tre settimane a settembre. I fjäll più settentrionali, intorno a Utsjoki e Kilpisjärvi, virano per primi a inizio settembre; Inari e Saariselkä raggiungono il picco verso la seconda settimana; Pallas, Levi e Pyhä seguono nella terza settimana; e Riisitunturi e Oulanka resistono fino a fine settembre, prima che le foglie cadano.' },
        { q: 'Qual è la stagione migliore per visitare la Lapponia?', a: 'Dipende da cosa è venuto a cercare. Scelga il kaamos (dicembre–gennaio) per l\'aurora e la neve, la primavera (aprile–maggio) per le lunghe giornate luminose con la neve ancora al suolo, il sole di mezzanotte (giugno–luglio) per il trekking e la pagaia, e il ruska (settembre) per i colori d\'autunno e le migliori fotografie di fjäll dell\'anno. Adatti la stagione al viaggio, e non il contrario.' },
  ...
  hiking: {
    ...
    trails: [
      { name: 'Sentiero Hetta–Pallas', description: 'Il sentiero di lunga percorrenza più popolare della Finlandia, attraversa la catena dei fjäll tra Hetta e Pallas. Terreno di fjäll aperto con viste d\'orizzonte, rifugi wilderness ben tenuti a intervalli ravvicinati.', distance: '55 km', duration: '3–4 giorni', difficulty: 'Medio' },
      ...
      { name: 'Sentieri giornalieri di Saariselkä', description: 'Sentieri giornalieri ben segnati dal villaggio di Saariselkä verso il parco nazionale. La giusta introduzione al trekking sui fjäll, con opzioni per ogni livello di forma e finestra meteo.', distance: '5–20 km', duration: '2–8 ore', difficulty: 'Facile' },
      { name: 'Sentiero dell\'Halti – il punto più alto della Finlandia', description: 'Trekking verso il punto più alto della Finlandia, sul fianco dell\'Halti, a 1.324 m. Percorso wilderness remoto attraverso l\'entroterra di Kilpisjärvi. La sezione finale non è segnata e richiede capacità di orientamento con scarsa visibilità.', distance: '55 km (andata e ritorno)', duration: '3–5 giorni', difficulty: 'Molto impegnativo' },
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Qual è il sentiero di trekking più popolare della Lapponia?', a: 'Il sentiero Hetta–Pallas di 55 km, che attraversa il Parco nazionale di Pallas-Yllästunturi, è l\'itinerario di lunga percorrenza più popolare della Finlandia. Si svolge quasi interamente sopra il limite degli alberi, con vedute sui fjäll aperti, e i rifugi sono distanziati per comode tappe di tre-quattro giorni tra Hetta e Pallas.' },
  ...
  conservation: {
    ...
    hero: {
      ...
      description: 'Metsähallitus gestisce l\'85 % delle aree dei fjäll della Lapponia e tutti i sette parchi nazionali. Il diritto d\'accesso alla natura finlandese consente a chiunque l\'accesso libero alla natura, con responsabilità.',
    },
    ...
    orgs: [
      { role: 'Gestione dei parchi nazionali', name: 'Metsähallitus (Parchi e fauna selvatica di Finlandia)', summary: 'Gestisce l\'85 % delle aree di fjäll della Lapponia e tutti e sette i parchi nazionali oltre il Circolo Polare Artico.', body: 'L\'azienda di Stato finlandese gestisce tutti i parchi nazionali, i sentieri, i rifugi wilderness e le aree protette della Lapponia. Si occupa dell\'infrastruttura dei sentieri, dei centri visitatori e dei programmi gratuiti di educazione ambientale.' },
    ...
    principles: [
      ...
      { title: 'Le renne hanno la precedenza', body: 'Circa 200.000 renne semidomestiche percorrono la Lapponia, non sono selvatiche, hanno un proprietario. Sulla strada rallenti; nei fjäll lasci spazio. Vicino ai recinti (poroaita), richiuda i cancelli dietro di sé.' }
    ],
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Chi gestisce i parchi nazionali e la wilderness della Lapponia?', a: 'Metsähallitus (Parchi e Fauna selvatica Finlandia), l\'ente statale, gestisce circa l\'85% delle aree dei fjäll della Lapponia e tutti i parchi nazionali, curando sentieri, rifugi liberi e centri visitatori. L\'azione di tutela arriva dall\'Associazione finlandese per la conservazione della natura (SLL) e dal WWF Finlandia, mentre il Parlamento sami detiene l\'autogoverno sulle questioni culturali e ambientali sami del nord.' },
