...
export const NL_OVERRIDES: DeepPartial<SectionCopy> = {
  ...
  newsletter: {
    ...
    benefits: [
      ...
      { title: 'Waar wij dit weekend heen zouden gaan', body: 'De donkere-hemelplek die de rit waard is. De rivier vóór de drukte van goudwassers. De fjäll die onze Sami-buren net fotografeerden.' },
    ],
  ...
  northernLights: {
    ...
    spots: [
      ...
      { name: 'Kilpisjärvi', description: 'Waar Finland, Zweden en Noorwegen samenkomen. Hooggelegen fjälls bieden panoramische auroras boven de wolkenlaag van de Noordelijke IJszee.' },
  ...
  nationalParks: {
    ...
    hero: {
      ...
      description: 'Vijf parken beschermen het leeuwendeel van de wegloze wildernis van Lapland, van traversen over open fjälls tot met sneeuw gekroonde bossen en goudwaskloven. Elk park heeft een eigen toegangsdorp om vanuit te vertrekken.',
    },
    parks: [
      { name: 'Nationaal park Urho Kekkonen', description: 'Het op één na grootste nationaal park van Finland: 2.550 km². Uitgestrekte open fjälls, diepe rivierkloven en oeroude dennenbossen. Een paradijs voor meerdaagse trektochten en backcountry-skiën.', highlight: '2ᵉ grootste park van Finland', visited: 'maart 2024 · Rumakuru-lus op ski\'s, sneeuw stabiel bij −12 °C' },
      { name: 'Nationaal park Pallas-Yllästunturi', description: 'Hier loopt de langste populaire fjäll-trektocht van Finland: de 55 km Hetta–Pallas-route. Open fjälltoppen met horizonten tot voorbij Käsivarsi.', highlight: 'Langste fjälltraversse van Finland', visited: 'september 2023 · Hetta → Pallas in drie dagen · ruska-piek week 2' },
      ...
      { name: 'Nationaal park Riisitunturi', description: 'Beroemd om zijn met sneeuw gekroonde bomen (tykky) die de hellingen van december tot maart in surrealistische ijssculpturen veranderen. De westgerichte fjälls leveren de zwaarste tykky van Finland.', highlight: 'Met sneeuw gekroonde bomen (tykky)', visited: 'februari 2024 · tykky op piekgewicht, blue-hour shoot om 14:30' },
  ...
  wildlife: {
    ...
    animals: [
      { name: 'Rendier', description: 'Zo\'n 200.000 halfgedomesticeerde rendieren trekken door Fins Lapland, al duizenden jaren centraal in de Sami-veehouderscultuur. Ze grazen vrij over fjälls en bossen, u komt ze tegen langs de weg.', status: 'Algemeen' },
      { name: 'Poolvos', description: 'Een van de zeldzaamste zoogdieren van Finland. De poolvos overleeft in de ruwste fjällomgevingen; de vacht wordt \'s winters wit voor sneeuwcamouflage. In de Scandinavische populatie kritiek bedreigd.', status: 'Kritiek bedreigd' },
      ...
      { name: 'Sneeuwuil', description: 'Een occasionele bezoeker van de noordelijkste fjälls; de sneeuwuil jaagt op lemmingen op de open toendra. Waarnemingen hangen af van de populatiecycli van de lemming en komen zelden voor ten zuiden van Utsjoki.', status: 'Zeldzame bezoeker' },
  ...
  seasons: {
    ...
    seasons: [
      { name: 'Ruska', period: 'September – oktober', description: 'Lapland barst los in felle herfstkleuren: berken, espen en bosbesstruiken kleuren goud, rood en oranje. Fjälltoppen doorlopen het spectrum in dagen, niet in weken. De ruska is een van de bepalende natuurgebeurtenissen van het Finse jaar, wandelaars reizen uit het hele land om hem te zien.' },
    ...
    ruskaWeeks: [
      { week: 'Week 1 · 2–8 sept.', region: 'Utsjoki + Kilpisjärvi (69°N en hoger)', body: 'De noordelijkste fjälls beginnen als eerste. Berken op 5 september al voor 60 % verkleurd; bosbessenstruiken diep rood. Kampeertemperaturen \'s nachts rond −2 °C. Fotograferenstijdvenster: 14:00–17:00, schuin licht.' },
  ...
  hiking: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Wat is het populairste wandelpad van Lapland?', a: 'De 55 km lange Hetta–Pallas-route door het nationale park Pallas-Yllästunturi is de populairste langeafstandsroute van Finland. Hij loopt vrijwel volledig boven de boomgrens met open fjäll-uitzichten, en de hutten liggen op comfortabele afstanden voor etappes van drie tot vier dagen tussen Hetta en Pallas.' },
  ...
  conservation: {
    ...
    principles: [
      ...
      { title: 'Rendieren hebben voorrang', body: 'Zo\'n 200.000 halfgedomesticeerde rendieren trekken door Lapland, zij zijn niet wild, zij hebben eigenaren. Vertraag op de weg; geef ze ruimte op de fjälls. Sluit bij hekken (poroaita) de poorten achter u.' }
    ],
