...
export const PTBR_OVERRIDES: DeepPartial<SectionCopy> = {
  ...
  wildlife: {
    ...
    animals: [
      ...
      { name: 'Urso-pardo', description: 'A Finlândia tem uma das populações de urso-pardo mais densas da Europa. No leste e no norte da Lapônia, os esconderijos permitem encontros próximos nas noites de verão, quando os ursos saem da hibernação.', status: 'Quase ameaçado' },
